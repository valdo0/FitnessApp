...
val sampleRecipes = listOf(
    RecipeItem(
        ...
        subtitle = "Una ensalada fresca y nutritiva.",
        imageUrl = "https://images.cookforyourlife.org/wp-content/uploads/2022/09/Citrus-Avocado-Salad.png",
        placeholderResId = R.drawable.placeholder_food
    ),
    RecipeItem(
        id = "2",
        title = "Salmón al Horno con hierbas y limón.",
        subtitle = "Un almuerzo completo y lleno de sabor.",
        imageUrl = "https://assets.tmecosys.com/image/upload/t_web_rdp_recipe_584x480/img/recipe/ras/Assets/3165C6C3-0E36-4D97-B740-B8E36A35762B/Derivates/b27829d5-8817-4989-9228-14da13505e05.jpg",
        placeholderResId = R.drawable.placeholder_food
    ),
    RecipeItem(
        id = "4",
